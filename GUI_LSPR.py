...
if (mode == 0):
    ...
    if (modes_option == 'Mode 1'):
        ...
        Results0 = smLSPR.size_modified_LSPR(x, R, AR_stdev, l, l_stdev, shape, mat, refind, 0, nPts) # Long
        Results1 = smLSPR.size_modified_LSPR(x, R, AR_stdev, l, l_stdev, shape, mat, refind, 1, nPts) # Trans
        ...
        Results0 = smLSPR.size_modified_LSPR(x, R, AR_stdev, l, l_stdev, shape, mat, refind, 0, nPts)
        Results2 = smLSPR.size_modified_LSPR(x, R, AR_stdev, l, l_stdev, shape, mat, refind, 2, nPts)
        ...
        Results0 = smLSPR.size_modified_LSPR(x, R, AR_stdev, l, l_stdev, shape, mat, refind, 0, nPts)
        Results3 = smLSPR.size_modified_LSPR(x, R, AR_stdev, l, l_stdev, shape, mat, refind, 3, nPts)
        ...
        Results0 = smLSPR.size_modified_LSPR(x, R, AR_stdev, l, l_stdev, shape, mat, refind, 0, nPts)
        Results1 = smLSPR.size_modified_LSPR(x, R, AR_stdev, l, l_stdev, shape, mat, refind, 1, nPts)
        Results2 = smLSPR.size_modified_LSPR(x, R, AR_stdev, l, l_stdev, shape, mat, refind, 2, nPts)
        Results3 = smLSPR.size_modified_LSPR(x, R, AR_stdev, l, l_stdev, shape, mat, refind, 3, nPts)
